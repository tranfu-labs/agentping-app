...
```bash
git tag -a v0.1.0 -m "Ageng网络医生 v0.1.0"
git push origin main --tags
gh release create v0.1.0 website/downloads/AgentPing.app.zip --repo tranfu-labs/agentping-app --title "Ageng网络医生 v0.1.0" --notes-file RELEASE_NOTES.md --latest
```
...
gh release view v0.1.0 --repo tranfu-labs/agentping-app --json name,tagName,isPrerelease,assets,url
```
